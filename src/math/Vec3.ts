...
export class Vec3 {
  ...
  public Get(axis: Vec3Axis): number {
    switch (axis) {
      case 0:
        return this.x
      case 1:
  ...
  public Assign(v: ReadonlyVec3): Vec3 {
    this.x = v.x
    this.y = v.y
    this.z = v.z
    return this
  ...
  public SetRow(x: number, y: number, z: number): Vec3 {
    this.x = x
    this.y = y
    this.z = z
    return this
  ...
  public Set(axis: Vec3Axis | number, value: number): Vec3 {
    switch (axis) {
      case 0:
        this.x = value
        break
  ...
  public SetAll(v: number): Vec3 {
    return this.SetRow(v, v, v)
  }

  public SetFromArray(array: [x: number, y: number, z: number]): Vec3 {
  ...
  public Add(rhs: ReadonlyVec3): Vec3 {
    this.x += rhs.x
    this.y += rhs.y
    this.z += rhs.z
    return this
  ...
  public Multiply(rhs: ReadonlyVec3): Vec3 {
    this.x *= rhs.x
    this.y *= rhs.y
    this.z *= rhs.z
    return this
  ...
  public MultiplyByNumber(n: number): Vec3 {
    this.x *= n
    this.y *= n
    this.z *= n
    return this
  ...
  public Scale = (n: number): Vec3 => this.MultiplyByNumber(n)

  public Divide(rhs: ReadonlyVec3): Vec3 {
    this.x /= rhs.x
    this.y /= rhs.y
    this.z /= rhs.z
    return this
  ...
  public DivideByNumber(n: number): Vec3 {
    this.x /= n
    this.y /= n
    this.z /= n
    return this
  ...
  public Inverse = (): Vec3 => this.SetRow(-this.x, -this.y, -this.z)
   ...
   * Copy
   */
  public static Copy(source: ReadonlyVec3, target?: Vec3): Vec3 {
   ...
   * DistanceSq
   */
  public static DistanceSq(a: ReadonlyVec3, b: ReadonlyVec3): number {
    const xp = a.x - b.x
    const yp = a.y - b.y
    const zp = a.z - b.z
